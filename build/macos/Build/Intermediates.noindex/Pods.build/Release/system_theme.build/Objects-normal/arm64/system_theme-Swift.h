...
#ifndef SYSTEM_THEME_SWIFT_H
#define SYSTEM_THEME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="system_theme",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class FlutterError;
SWIFT_CLASS("_TtC12system_theme17SystemThemePlugin")
@interface SystemThemePlugin : NSObject <FlutterPlugin, FlutterStreamHandler>
