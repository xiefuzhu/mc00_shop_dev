...
class _MineViewState extends State<MineView> {
  ...
  void _getGuessList() async {
    ...
    _isLoading = true;
    final result = await getGoodsDetailItemsAPI(_params);
    if (!mounted) {
      _isLoading = false;
      return;
    }
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverPersistentHeader(delegate: Mc00Guess(), pinned: true),
        Mc00morelist(productlist: _list), //上拉加载
        // 猜你喜欢
      ],
    );
  }
